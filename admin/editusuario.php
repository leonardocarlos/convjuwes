...
<div class="controls-row">
    ...
    <div class="span5">
		...
		<input type="text" name="endereco" class="span5" id="endereco" value="<?php echo $usuario['endereco'] ;?>"/>
    </div>
    <div class="span1">
  		<label>Número:</label>
...
<div class="controls-row">  
	...
	<div class="span4">
		<label>Igreja:</label>
		<input type="text" name="igreja" class="span4" value="<?php echo $usuario['igreja'] ;?>"/>
	</div>
	<div class="span3">
		<label>Pastor:</label>
...
<div class="controls-row">
	<div class="span2">
            <label>Login:</label>
            <input type="text" name="login" class="span2" required value="<?php echo $usuario['login'] ;?>"/>
        </div>
	<div class="span2">
		<label>Senha:</label>
